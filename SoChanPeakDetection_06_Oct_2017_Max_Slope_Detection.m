...
% Edits 
% Implementation of So and Chan (Max Slope detection method) with no tweaks
...
hold on
plot(win_markers,slope_thresholds,'marker','v','color', 'y', 'MarkerSize', 6);
hold on
plot(missed_win_locs,missed_win_markers,'marker','v','color', 'm', 'MarkerSize', 6);
title('Max Abs Slope Detection based QRS Detection (param = 5, temp_size  = 120, filt_param = 16)');

%figure;plot(RRI);
%title('Max Slope Detection based RRI');
%
